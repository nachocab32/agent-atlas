...
export function PanelReferencia() {
  ...
  return <aside className={`h-full shrink-0 overflow-y-auto border-l border-border bg-background max-md:fixed max-md:inset-0 max-md:z-40 max-md:w-full ${completo ? 'w-1/2' : 'w-[312px]'}`} aria-label="Referencia consultada">
